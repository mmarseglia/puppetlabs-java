...
#
# Uses the following URL to download the package and automatically accept
# the licensing terms.
# wget --no-cookies --no-check-certificate --header \
# "Cookie: gpw_e24=http%3A%2F%2Fwww.oracle.com%2F; oraclelicense=accept-securebackup-cookie" \
# "http://download.oracle.com/otn-pub/java/jdk/8u25-b17/jre-8u25-linux-x64.tar.gz"
#
# URL is constructed using the following variables:
# 8u25-b17/jre-8u25-linux-x64.tar.gz
# ${release_major}-{$release_minor}/${java_se}-${release_major}-${os}-${architecture}.tar.gz
#
# Parameters
# [*version*]
...
define java::oracle (
  ...
  case $version {
    ...
    '8' : {
      $release_major = '8u102'
      $release_minor = 'b14'
      $install_path = "${java_se}1.8.0_102"
    }
    default : {
      $release_major = '8u102'
      $release_minor = 'b14'
